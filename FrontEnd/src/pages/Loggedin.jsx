...
const Loggedin = () => {
  ...
  return (
    <Box sx={{ height: "100vh", maxWidth: "100vw" }}>
      <MessageDialog open={open} setId={setId} setOpen={setOpen} message={msg} setMsg={setMsg}/>
      <Stack
        direction="row"
        sx={{
      ...
      >
        ...
        <Stack direction="row" alignItems="center" spacing={1} sx={{ mx: 2 }}>
          <Typography sx={{ fontSize: "18px" }}>{userInfo? userInfo.name : ""}</Typography>
          <Button
      ...
      <Grid container sx={{ px: 3, mt: 2 }} columnSpacing={3} rowSpacing={2}>
        <Grid item xs={12} md={6}>
          ...
          >
            ...
            >
              <Typography sx={{ fontSize: "40px", wordWrap: "nowrap" }}>
                Notifications
              </Typography>
        ...
        <Grid item xs={12} md={6}>
          ...
          >
            ...
            >
              <Typography fontSize="40px">Transfer data securely</Typography>
